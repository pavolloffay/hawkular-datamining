...
\begin{ThesisAbstract}          % The abstract
  ...
  and management platform Hawkular. The module should provide real time predictive capabilities for time series data
  being collected. Proposed solution should be computationally efficient and more importantly it should autonomously
  select the best time series model for given metric. In other words it should work without an analyst interaction.

  The master's thesis starts with time series theory and analysis of various approaches for time series forecasting. It
  discuss which models are best for Hawkular requirements. The implementation chapter focuses on the most important
  ...
  The results show that implemented models are from the prediction accuracy perspective similar to R alternatives.
