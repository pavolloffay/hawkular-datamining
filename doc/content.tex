...
overview of this domain.
    ...
    rivals and if application offers predictive capabilities.
...
The used methodology and more comprehensive description of tested objectives is listed in Section \ref{sec:methodology}.
    ...
    From the test results it can be shown how many tests cases have lower ratio or even better is to split ratios into
    following intervals:
...
Data Mining prediction engine autonomously selects the best time series model for underlying time series. The most
importantly it is capable dealing with concept drift problem. So in production there is no need of any
